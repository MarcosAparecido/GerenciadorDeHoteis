...
private TipoService tipoService = new TipoService();
    ...
    public GerenciamentoCheckInCheckOut(String cpfFuncionario, String cpfHospede, String passaporteHospede) {
        ...
        mskInicial.setText("20072024");
        mskFinal.setText("27072024");
    }
    ...
    private void initComponents() {
        ...
        mskInicial = new javax.swing.JFormattedTextField();
        mskFinal = new javax.swing.JFormattedTextField();
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 570, -1, -1));
        ...
        try {
            mskInicial.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        jPanel1.add(mskInicial, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 550, -1, -1));

        try {
            mskFinal.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        mskFinal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mskFinalActionPerformed(evt);
            }
        });
        jPanel1.add(mskFinal, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 640, 130, 60));
    ...
    private void mskFinalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mskFinalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_mskFinalActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         DatasUtil datasUtil = new DatasUtil();
          Date inicial = datasUtil.converterStringParaData(mskInicial.getText());
        Date dFinal = datasUtil.converterStringParaData(mskFinal.getText());
         tipoService.validarData(inicial, dFinal);
    ...
    private javax.swing.JFormattedTextField mskFinal;
    private javax.swing.JFormattedTextField mskInicial;
...
//        }
        tipoService.validarData(inicial, dFinal);
//        Reserva reserva = new Reserva(funcionario, quarto, nome, numeroHospedesNumero, nomeQuarto, true, dataCheckIn, null, inicial, dFinal);
...
//        limparAcompanhantes();
        ...
        tbReserva.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getClickCount() == 2) {
                    ...
                    if (index != -1) {
                        idSelecionadoHospede = (int) tbReserva.getValueAt(index, 1);
    ...
    public int getIdSelecionadoHospede() {
        return idSelecionadoHospede;
    }

    public void setIdSelecionadoHospede(int idSelecionadoHospede) {
        this.idSelecionadoHospede = idSelecionadoHospede;
    }
